...
"""
"""
#فكرة هذة العبة هو اختيار رقم معين من القوائم بدون تحديدة او ذكرة ثم يضغط على اسم المجموعة وعندما يظهر مرة اخرى يختار اسم المجموعة وتستمر العملية ثلاث مرات ثم يظهر الرقم الذي اخترتة
"""
